 ...
 */
function str_nodouble($source, $replace = '-', $case_insensitive = true){
    return preg_replace('/(.)\1{2,}/u'.($case_insensitive ? 'i' : ''), $replace, $source);
}
 ...
 * Adapted by Sven Oostnbrink support@svenoostenbrink.com for use in BASE project
 */
function str_diff(){
    try{
