...
$_CONFIG['cache']              = array('method'           => 'file',                                                                    // "file", "memcached" or false.
                                       ...
                                       'http'             => array('enabled'            => true,                                        // Enable HTTP cache or not
                                                                   'policy'             => 'public, max-age=604800'));                  // Either "no-store", or "no-cache" with "public" or "private", optionally with max-age=N" where N is a natural number
...
$_CONFIG['security']           = array('signin'           => array('save_password'    => true,                                          // Allow the browser client to save the passwords. If set to false, different form names will be used to stop browsers from saving passwords
                                       ...
                                       'authentication'   => array('captcha_failures' => 2,                                             // Authentication failures until re-captcha is required. If 0, recaptcha will be required with every authentication. If set to FALSE, captcha will be disabled completely
                                                                   'auto_lock_fails'  => 5,                                             // Upon N authentication failures, auto lock user accounts. Set to 0 to disable
