...
sql_index_exists ('blogs_posts', 'seocategory2', 'ALTER TABLE `blogs_posts` ADD INDEX  (`seocategory1`)');
sql_index_exists ('blogs_posts', 'seocategory3', 'ALTER TABLE `blogs_posts` ADD INDEX  (`seocategory1`)');
