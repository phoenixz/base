...
sql_query('ALTER TABLE `domains_servers` ADD        KEY `domains_id` (`domains_id`)');
sql_query('ALTER TABLE `domains_servers` ADD UNIQUE KEY `domains_servers` (`domains_id`, `servers_id`)');

sql_query('ALTER TABLE `domains_servers` ADD CONSTRAINT `fk_domains_servers_domains_id` FOREIGN KEY (`domains_id`) REFERENCES `domains` (`id`) ON DELETE CASCADE;');
sql_query('ALTER TABLE `domains_servers` ADD CONSTRAINT `fk_domains_servers_servers_id` FOREIGN KEY (`servers_id`) REFERENCES `servers` (`id`) ON DELETE CASCADE;');
?>
